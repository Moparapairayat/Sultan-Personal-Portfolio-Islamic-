...
│  ├─ Tailwind Animate (Built-in animations)
...
|----------|---------|---------|
| **UI Framework** | `react@19` | User interface |
| **Router** | `next@15` | App routing |
| **Styling** | `tailwindcss@3.4` | CSS utility framework |
...
│   ├── protocol-dashboard.tsx           # Admin dashboard
...
```bash
Node.js 18.17+  •  npm/yarn/pnpm  •  Git
```
...
#### Step 3️⃣ Environment Setup (Optional)
```bash
# Create configuration file
cp .env.example .env.local

# Add your API keys
NEXT_PUBLIC_PIPRAPAY_API_KEY=your_key_here
...
Control animations via component props:
```tsx
<IslamicPatterns 
  animate={true}        // Enable animations
  intensity={0.8}       // Animation speed (0-1)
  rotationSpeed="slow"  // slow | normal | fast
/>
```
...
Automatically routed to `/your-page` ✨
...
Build & run:
```bash
docker build -t sultan-portfolio .
docker run -p 3000:3000 sultan-portfolio
```
...
**[Give a Star ⭐](https://github.com/Moparapairayat/Sultan-Personal-Portfolio-Islamic-) if you found this helpful!**
